...
(function () {
  ...
  function initTheme() {
    let theme = null;
    try { theme = localStorage.getItem("tc_theme"); } catch {}
      ...
      <header class="site-header">
        <div class="header-inner">
          ...
          <div class="header-actions">
            <button class="theme-toggle" id="theme-toggle" aria-label="Basculer entre mode clair et mode sombre"></button>
    ...
    area.innerHTML = `
      <div class="profile-wrap">
        ...
        <div class="profile-menu" id="profile-menu">
          ...
          <a href="notifications.html">${ICON.bell} Notifications<span class="notif-badge" id="notif-badge" hidden></span></a>
